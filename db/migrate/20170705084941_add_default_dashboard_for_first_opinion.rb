class AddDefaultDashboardForFirstOpinion < ActiveRecord::Migration
  def up
...
CHECK (
  ...
  (
    provider = 'first_opinion' AND (
      dashboard_type = 'new-users' OR
      dashboard_type = 'messages-to-bot' OR
      dashboard_type = 'messages-from-bot' OR
      dashboard_type = 'conversations' OR
      dashboard_type = 'custom'
    )
  ) OR (
    provider = 'telegram'
...
CHECK (
  ...
  (
    provider = 'first_opinion' AND (
      dashboard_type = 'new-users' OR
      dashboard_type = 'messages-to-bot' OR
      dashboard_type = 'messages-from-bot'
      dashboard_type = 'custom'
    )
  ) OR (
    provider = 'telegram'
